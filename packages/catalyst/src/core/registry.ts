...
function createDefaultItemsSection(): ItemsSectionSchema {
  return {
    ...
    fields: {
      ...
      description: {
        type: 'text',
        value: { en: 'Built for teams that care about performance, accessibility, and developer experience.' },
      },
      items: {
        type: 'list',
        value: [
          {
            ...
            description: { en: 'Fully WCAG 2.0 compliant, built with best accessibility practices from day one.' },
          ...
          },
          {
            ...
            description: { en: 'Looks and works great on any device and screen size, from mobile to ultrawide.' },
          ...
          },
          {
            ...
            description: { en: 'Seamless switching between color schemes with six built-in themes included.' },
          ...
          },
          {
            ...
            description: { en: 'Optimized for lightning-fast load times and silky-smooth interactions.' },
